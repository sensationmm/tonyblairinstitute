	...
	<div class="body">
		...
		<div class="news-list content-pad">
			...
			<article class="news-item animate">
				...
				<div class="news-article-text">
					<div class="news-article-date">04.05.2016</div>
					<div class="news-article-title"><h2>Only a strong centre can defeat the populist surge2</h2></div>
		...
		<div class="load-more">
			<div class="read-more"><a href="/static/news3.php">Load more articles</a></div>
		</div>
